export const PROJECTS = [
  ...
  },
  {
    ...
    linkLabel: 'GitHub →',
    linkCls: 'eng',
    img: '/images/HealthExpenditurePrediction.PNG',
    cat: 'eng',
  },
]
...
export const ART_ITEMS = [
  { src: '/drawings/ReflectionMicrone.jpg',  label: 'Reflection Microne',  cat: 'drawing'      },
  { src: '/drawings/BeautyOfNature.jpg',     label: 'Beauty of Nature',    cat: 'drawing'      },
  { src: '/drawings/NASA.JPG',               label: 'NASA - Digital',      cat: 'digital'      },
  { src: '/drawings/stilllife1.JPG',         label: 'Still Life I',        cat: 'drawing'      },
  { src: '/architecture/Image1.PNG',         label: 'Architectural Study I',   cat: 'architecture' },
  { src: '/drawings/flower_heart.PNG',       label: 'Flower Heart',        cat: 'digital'      },
  { src: '/drawings/SoftPastel.jpg',         label: 'Soft Pastel',         cat: 'drawing'      },
  { src: '/architecture/Image2.jpg',         label: 'Architectural Study II',  cat: 'architecture' },
  { src: '/drawings/portrait.png',           label: 'Digital Portrait',    cat: 'digital'      },
  { src: '/drawings/VirtualLearning.jpg',    label: 'Virtual Learning',    cat: 'drawing'      },
  { src: '/architecture/Image3.jpg',         label: 'Architectural Study III', cat: 'architecture' },
  { src: '/drawings/sketch.JPG',             label: 'Sketch Study',        cat: 'drawing'      },
  { src: '/architecture/Image4.PNG',         label: 'Architectural Study IV',  cat: 'architecture' },
  { src: '/drawings/stilllife2.jpg',         label: 'Still Life II',       cat: 'drawing'      },
  { src: '/architecture/Image5.jpg',         label: 'Architectural Study V',   cat: 'architecture' },
  { src: '/drawings/hand.jpg',               label: 'Hand Study',          cat: 'digital'      },
  { src: '/architecture/Image6.jpg',         label: 'Architectural Study VI',  cat: 'architecture' },
  { src: '/drawings/ChangesOverTime.jpg',    label: 'Changes Over Time',   cat: 'drawing'      },
  { src: '/drawings/Painting.jpg',           label: 'Painting Study',      cat: 'drawing'      },
]
